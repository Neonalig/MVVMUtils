...
namespace MVVMUtils.Controls {
	...
	public partial class PathBrowser : INotifyPropertyChanged {
		...
		public string TestPath {
			get { return (string)GetValue(TestPathProperty); }
			set { SetValue(TestPathProperty, value); } //TODO: FUCK THIS, SERIOUSLY
		}

		// Using a DependencyProperty as the backing store for TestPath.  This enables animation, styling, binding, etc...
		public static readonly DependencyProperty TestPathProperty =
	DependencyProperty.Register("TestPath", typeof(string), typeof(PathBrowser), new PropertyMetadata(string.Empty));
		...
		public void OnPathChanged( string? NewPath ) => PathChanged.Invoke(this, NewPath);
